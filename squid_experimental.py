...
class Params:
    ...
    injection_start = 30e-3 # Current clamp experimental injection current start in time. measured(0 to injection_start in seconds).
    #injection_end = 60e-3 # Current clamp experimental injection current end in time. measured(0 to injection_end in seconds).
    injection_end = 160e-3 # Current clamp experimental injection current end in time. measured(0 to injection_end in seconds).
    ...
    baseline_before = 30e-3 # Resting membrane potential(RMP), measured (0 to baseline_before time in seconds).
    ...
    steady_after = 70e-3 # Time interval to wait before measuring steady state depolarization
    steady_cutoff = 80
